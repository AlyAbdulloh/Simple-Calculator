...
tamp.addEventListener('click', function () {
  if (tamp.innerText === "Show History"){
    tamp.innerText = "Close History";
    his.classList.add("showHis");

  }else{
    tamp.innerText = "Show History";
    his.classList.remove("showHis");
  }
})
